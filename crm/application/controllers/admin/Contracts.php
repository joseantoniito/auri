...
class Contracts extends Admin_controller
{
    ...
    public function contract($id = '')
    {
        ...
        if($id != ''){
            if(total_rows('tblclients',array('active'=>0,'userid'=>$data['contract']->client)) > 0
                || (total_rows('tblcustomeradmins',array('staff_id'=>get_staff_user_id(),'customer_id'=>$data['contract']->client)) == 0 && !has_permission('customers','','view'))){
