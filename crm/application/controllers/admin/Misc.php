...
class Misc extends Admin_controller
{
    ...
    public function toggle_file_visibility($id){
        ...
        $this->db->where('id',$id);
        $this->db->update('tblfiles',array('visible_to_customer'=>$v));
        echo $v;
    }
    ...
    public function update_ei_items_order($type){
        ...
        foreach($data['data'] as $order){
            ...
            $this->db->update('tblitems_in',array('item_order'=>$order[1]));
        }
    }
   ...
   public function add_note($rel_id,$rel_type){
    ...
    public function edit_note($id){
        if($this->input->post()){
            ...
            echo json_encode(array('success'=>$success,'message'=>_l('note_updated_successfuly')));
        }
    }
