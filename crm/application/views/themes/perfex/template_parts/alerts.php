<?php if(is_client_logged_in() && isset($is_home)){
    ...
    <div class="panel_s">
        ...
        <div class="panel-body announcement mbot15 tc-content">
            <div class="text-info alert-dismissible" role="alert">
                ...
                <h4 class="bold no-margin font-medium"><?php echo _l('announcement'); ?>! <?php if($__announcement['showname'] == 1){ echo '<br /><small>'._l('announcement_from').' '. $__announcement['userid']; } ?></small><br /><small>Added: <?php echo _dt($__announcement['dateadded']); ?></small></h4>
            </div>
            <hr />
