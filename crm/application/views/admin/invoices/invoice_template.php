       ...
       <span class="billing_city">
         ...
         <span class="billing_state">
           ...
           <div class="col-md-6">
            ...
            <?php if(total_rows('tblemailtemplates',array('slug'=>'invoice-overdue-notice','active'=>0)) == 0){ ?>
            <div class="form-group">
...
<div class="col-md-6">
  <select name="repeat_type_custom" id="repeat_type_custom" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
   ...
   <option value="year" <?php if(isset($invoice) && $invoice->custom_recurring == 1 && $invoice->recurring_type == 'year'){echo 'selected';} ?>><?php echo _l('invoice_recuring_years'); ?></option>
 </select>
</div>
</div>
...
<tbody>
 ...
 <td>
   <textarea name="long_description" class="form-control" placeholder="<?php echo _l('item_long_description_placeholder'); ?>"></textarea>
 </td>
 <td>
 ...
 <td>
   ...
   $select = '<select class="selectpicker display-block tax main-tax" data-container="body" data-width="100%" name="taxname" multiple data-live-search="true">';
   $no_tax_selected = '';
   if($default_tax == ''){
