                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="display-block pull-left mleft5">
                                <a href="#" class="btn btn-default" onclick="slideToggle('#stats-top'); init_estimates_total(true); return false;" data-toggle="tooltip" title="<?php echo _l('view_stats_tooltip'); ?>"><i class="fa fa-bar-chart"></i></a>
                            </div>
                            <?php } ?>
