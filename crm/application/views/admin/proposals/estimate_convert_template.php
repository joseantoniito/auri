<div class="modal fade proposal-convert-modal" id="convert_to_estimate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog full-screen-modal" role="document">
        <?php echo form_open('admin/proposals/convert_to_estimate/'.$proposal->id,array('id'=>'proposal_convert_to_estimate_form','class'=>'_transaction_form')); ?>
...
<script>
    ...
    $('#convert_to_estimate #clientid').selectpicker('val',<?php echo $clientid; ?>);
