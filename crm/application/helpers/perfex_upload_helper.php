                ...
                $insert_id = $CI->db->insert_id();
                    ...
                    if($insert_id){
                        ...
                        $notification_data = array(
                           ...
                           'link'=>'projects/view/'.$project_id.'?group=project_files&file_id='.$insert_id,
                           );
                        if(is_client_logged_in()){
                   ...
                   $CI->projects_model->send_project_email_template(
                       $project_id,
                        ...
                        $data['visible_to_customer'],
                        array(
                        'staff'=>array('discussion_id'=>$insert_id,'discussion_type'=>'file'),
                        'customers'=>array('customer_template'=>true,'discussion_id'=>$insert_id,'discussion_type'=>'file'),
                                )
                    );
                    } else {
                        unlink($newFilePath);
