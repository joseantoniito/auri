...
function init_relation_tasks_table($table_attributes = array())
{
    ...
    if (has_permission('tasks', '', 'create')) {
        ...
        echo "<a href='#' class='btn btn-info pull-left mbot25" . $disabled . "' onclick=\"new_task_from_relation('$table_name'); return false;\">" . _l('new_task') . "</a>";
        if ($table_attributes['data-new-rel-type'] == 'project') {
            echo "<a href='" . admin_url('tasks/list_tasks?project_id=' . $table_attributes['data-new-rel-id'] . '&kanban=true') . "' class='btn btn-default pull-left mleft5' >" . _l('view_kanban') . "</a>";
        }
