...
class Staff_model extends CRM_Model
{
    ...
    public function delete($id,$transfer_data_to){
        ...
        $this->db->update('tblestimates',array('addedfrom'=>$transfer_data_to));

        $this->db->where('sale_agent',$id);
        $this->db->update('tblestimates',array('sale_agent'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblinvoices',array('addedfrom'=>$transfer_data_to));

        $this->db->where('sale_agent',$id);
        $this->db->update('tblinvoices',array('sale_agent'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblexpenses',array('addedfrom'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblnotes',array('addedfrom'=>$transfer_data_to));

        $this->db->where('userid',$id);
        $this->db->update('tblpostcomments',array('userid'=>$transfer_data_to));

        $this->db->where('creator',$id);
        $this->db->update('tblposts',array('creator'=>$transfer_data_to));

        $this->db->where('staff_id',$id);
        $this->db->update('tblprojectdiscussions',array('staff_id'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblprojects',array('addedfrom'=>$transfer_data_to));

        $this->db->where('staffid',$id);
        $this->db->update('tblprojectfiles',array('staffid'=>$transfer_data_to));

        $this->db->where('staffid',$id);
        $this->db->update('tblproposalcomments',array('staffid'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblproposals',array('addedfrom'=>$transfer_data_to));

        $this->db->where('staffid',$id);
        $this->db->update('tblstafftaskcomments',array('staffid'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblstafftasks',array('addedfrom'=>$transfer_data_to));
        ...
        $this->db->update('tbltaskchecklists',array('finished_from'=>$transfer_data_to));

        $this->db->where('admin',$id);
        $this->db->update('tblticketreplies',array('admin'=>$transfer_data_to));

        $this->db->where('admin',$id);
        $this->db->update('tbltickets',array('admin'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblleads',array('addedfrom'=>$transfer_data_to));

        $this->db->where('assigned',$id);
        $this->db->update('tblleads',array('assigned'=>$transfer_data_to));

        $this->db->where('staff_id',$id);
        $this->db->update('tbltaskstimers',array('staff_id'=>$transfer_data_to));

        $this->db->where('addedfrom',$id);
        $this->db->update('tblcontracts',array('addedfrom'=>$transfer_data_to));
        ...
        $this->db->where('assigned',$id);
        $this->db->update('tbltickets',array('assigned'=>0));
        ...
        do_action('staff_member_deleted',array('id'=>$id,'transfer_data_to'=>$transfer_data_to));
        return true;
    }
    /**
     * Get staff member/s
